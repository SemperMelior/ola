...
class AxesDrawer
{
    ...
    //4A4A4A
    var color = UIColor(red: 0x8e/255, green: 0x8e/255, blue: 0x93/255, alpha: 1.0)
    ...
    func drawTwoAxes(dx: Double, dy: Double, bounds: CGRect, pointsPerUnit: CGFloat) {
        ...
        path.addLineToPoint(CGPoint(x: x, y: y+dy))
        path.stroke()
        path.moveToPoint(CGPoint(x: x, y: y+dy))
        path.addLineToPoint(CGPoint(x: x+dx, y: y+dy))
        path.stroke()
        drawHashmarksInRect(bounds, origin: CGPoint(x: x, y: y+dy), pointsPerUnit: pointsPerUnit)
    }
    
    func drawInsulinGraph(dx:Double, dy:Double) {
        let path = UIBezierPath()
        path.lineWidth = 2
        color = UIColor(red: 0x57/255, green: 0xb0/255, blue: 0xe6/255, alpha: 0.8)
        color.set()
        let x = 0.0
        let y = 10.0
        path.moveToPoint(CGPoint(x: x, y: y+dy))
        path.addLineToPoint(CGPoint(x: x+dx/3.0, y: y+dy/3.0))
        path.stroke()
        path.moveToPoint(CGPoint(x: x+dx/3.0, y: y+dy/3.0))
        path.addLineToPoint(CGPoint(x: x+2.0*dx/3.0, y: y+dy/3.0))
        path.stroke()
        path.moveToPoint(CGPoint(x: x+2.0*dx/3.0, y: y+dy/3.0))
        path.addLineToPoint(CGPoint(x: x+dx, y: y+2.0*dy/3.0))
        path.stroke()
        
    }
    
    func drawGlucoseGraph(dx:Double, dy:Double) {
        let path = UIBezierPath()
        path.lineWidth = 2
        color = UIColor(red: 0x57/255, green: 0xb0/255, blue: 0xe6/255, alpha: 0.8)
        color.set()
        ...
        let y = 10.0
        path.moveToPoint(CGPoint(x: x, y: y+dy))
        path.addLineToPoint(CGPoint(x: x+dx/4.0, y: y+dy/4.0))
        path.stroke()
        path.moveToPoint(CGPoint(x: x+dx/4.0, y: y+dy/4.0))
        path.addLineToPoint(CGPoint(x: x+dx/2.0, y: y+dy/3.0))
        path.stroke()
        path.moveToPoint(CGPoint(x: x+dx/2.0, y: y+dy/3.0))
        path.addLineToPoint(CGPoint(x: x+3.0*dx/4.0, y: y+3.0*dy/4.0))
        path.stroke()
        path.moveToPoint(CGPoint(x: x+3.0*dx/4.0, y: y+3.0*dy/4.0))
        path.addLineToPoint(CGPoint(x: x+dx, y: y))
        path.stroke()
